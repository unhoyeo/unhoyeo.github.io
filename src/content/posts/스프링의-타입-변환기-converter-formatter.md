...
특히 웹 애플리케이션에서는 HTTP <strong>요청 파라미터</strong>가 항상 <strong>문자열(String)</strong>로 전달되기 때문에,
...
추가적으로 <strong>Locale 정보를 사용</strong>하여 각 나라의 문화권에 맞는 <strong>형식(예: 날짜, 숫자, 통화)</strong>으로 변환하는 기능을 제공한다.

예를 들어, 숫자 1000을 한국에서는 <strong>"1,000"</strong>으로, 독일에서는 <strong>"1.000"</strong>으로 변환하는 등 현지화(i18n) 처리가 필요할 때 사용된다.
...
숫자 1000을 <strong>"1,000"</strong>으로, 즉 1000 단위로 쉼표가 들어가는 포맷을 적용해 보자.
