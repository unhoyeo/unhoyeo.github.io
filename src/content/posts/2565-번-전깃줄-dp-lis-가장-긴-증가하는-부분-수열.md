---
title: "2565번 전깃줄 - DP (LIS, 가장 긴 증가하는 부분 수열)"
...
![2565번 전깃줄 - DP (LIS, 가장 긴 증가하는 부분 수열)](/images/tistory/120/img.png)
...
- <strong>A 기준으로 정렬한 뒤, B 값들에서 가장 긴 증가 부분 수열(LIS)</strong>을 찾으면, <strong>교차하지 않는 최대 전깃줄 수</strong>가 된다.
