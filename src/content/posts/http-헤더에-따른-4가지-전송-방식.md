...
- **Range 단위**는 기본적으로 **바이트**지만, 다른 단위도 확장 가능 (HTTP Range Units)
- **여러 범위**를 요청할 수도 있다. (예: Range: bytes=0-499,1000-1499)
...
- **클라이언트가 Range 요청**을 보냈고, **서버가 이를 수락했을 경우** 반환하는 상태 코드
