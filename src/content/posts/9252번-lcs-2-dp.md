...
- <strong>dp[lenA][lenB]</strong>에서 시작해서 <strong>거꾸로 탐색</strong>
...
- <strong>LCS(i, j)</strong>는 <strong>A[0...i]와 B[0...j]</strong>의 LCS 길이를 반환하는 함수
- <strong>메모이제이션 (dp[i][j] 값이 -1이 아닐 경우)</strong>으로 <strong>중복 계산 방지</strong>
