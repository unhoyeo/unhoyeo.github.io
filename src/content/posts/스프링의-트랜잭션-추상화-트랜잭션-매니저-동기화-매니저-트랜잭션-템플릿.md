...
2. 이후 리포지토리에서는 **DataSourceUtils.getConnection()**을 통해 ThreadLocal에 보관된 **커넥션을 꺼내 사용**한다.
...
이는 **템플릿 콜백 패턴**을 활용한 것으로, 개발자는 **반복적인 트랜잭션 처리(시작, 커밋, 롤백)**는 템플릿에 맡기고,
...
**?** 개발자는 단지 **application.properties** 파일에 **데이터베이스 연결 정보**만 입력하면 된다!
