...
description: "N(2 ≤ N ≤ 50,000)개의 정점으로 이루어진 트리가 주어진다. 트리의 각 정점은 1번부터 N번까지 번호가 매겨져 있으며, 루트는 1번이다."
...
- 단순히 각 노드의 **부모 배열**을 구하고, 부모를 타고 올라가면 **O(N)**이라 느림
- **Binary Lifting (이진 점프)** 기법을 사용하면 **O(log N)**에 구할 수 있음
