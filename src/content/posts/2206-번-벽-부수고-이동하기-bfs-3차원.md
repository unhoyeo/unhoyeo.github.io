---
title: "2206번 벽 부수고 이동하기 - BFS (3차원)"
...
- BFS는 한 번 방문한 노드를 다시 방문하지 않으므로 <strong>O(N\*M)</strong>의 시간 복잡도를 갖는다.
- 벽을 부수는 경우를 추가로 고려해야 하므로, 최악의 경우 <strong>O(2 \* N \* M)</strong>이 된다.
